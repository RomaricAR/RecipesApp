...
// Model representing the detailed information of a recipe.
struct RecipeDetailsModel: Identifiable, Codable {
    ...
    init(recipeName: String, instructions: String, recipeThumbnailURL: String, recipeID: String, ingredients: [String], measurements: [String]) {
    ...
    // Custom initializer to decode the recipe details from the API response.
